...
function Graph(el, nodes, links, options) {
  ...
  this.opts.showTitle = options.showTitle || defaults.showTitle;
  this.opts.curvedLinks = options.curvedLinks || defaults.curvedLinks;
...
//        .attr("height", this.opts.height)
  ...
  isTitleDisplayable: function(d) {
    ...
    return this.opts.showTitle && (scale * res > .8 || scale == this.opts.zoomScaleExtent[1] ) && (this.isAdjacent(d) || this.isFocused(d));
  },
  ...
  updateLinksPosition: function() {
    ...
    var curvedLink = this.opts.curvedLinks;
